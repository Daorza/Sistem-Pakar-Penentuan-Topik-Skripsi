...
Partial Class FormAddEditQuestion
    ...
    Private Sub InitializeComponent()
        ...
        txtPertanyaan = New Guna.UI2.WinForms.Guna2TextBox()
        cboLevel = New Guna.UI2.WinForms.Guna2ComboBox()
        cboKategori = New Guna.UI2.WinForms.Guna2ComboBox()
        cboTargetTopic = New Guna.UI2.WinForms.Guna2ComboBox()
        cboTargetSubtopic = New Guna.UI2.WinForms.Guna2ComboBox()
        cboTargetMetode = New Guna.UI2.WinForms.Guna2ComboBox()
        cboTargetRekomendasi = New Guna.UI2.WinForms.Guna2ComboBox()
        txtCFPakar = New Guna.UI2.WinForms.Guna2TextBox()
        btnSave = New Guna.UI2.WinForms.Guna2Button()
        btnCancel = New Guna.UI2.WinForms.Guna2Button()
        lblTarget = New Guna.UI2.WinForms.Guna2HtmlLabel()
        ...
        ' txtPertanyaan
        ' 
        txtPertanyaan.BorderRadius = 8
        txtPertanyaan.CustomizableEdges = CustomizableEdges1
        txtPertanyaan.DefaultText = ""
        txtPertanyaan.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtPertanyaan.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtPertanyaan.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtPertanyaan.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtPertanyaan.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtPertanyaan.Font = New Font("Segoe UI", 9F)
        txtPertanyaan.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtPertanyaan.Location = New Point(87, 69)
        txtPertanyaan.Margin = New Padding(3, 4, 3, 4)
        txtPertanyaan.Name = "txtPertanyaan"
        txtPertanyaan.PlaceholderText = ""
        ...
        cboLevel.BorderRadius = 8
        cboLevel.CustomizableEdges = CustomizableEdges3
        ...
        cboLevel.Size = New Size(175, 36)
        cboLevel.TabIndex = 1
        ' 
        ' cboKategori
        ' 
        cboKategori.BackColor = Color.Transparent
        cboKategori.BorderRadius = 8
        cboKategori.CustomizableEdges = CustomizableEdges5
        cboKategori.DrawMode = DrawMode.OwnerDrawFixed
        ...
        cboKategori.Size = New Size(175, 36)
        cboKategori.TabIndex = 2
        ' 
        ' cboTargetTopic
        ' 
        cboTargetTopic.BackColor = Color.Transparent
        cboTargetTopic.BorderRadius = 8
        cboTargetTopic.CustomizableEdges = CustomizableEdges7
        cboTargetTopic.DrawMode = DrawMode.OwnerDrawFixed
        ...
        cboTargetTopic.Size = New Size(175, 36)
        cboTargetTopic.TabIndex = 4
        ' 
        ' cboTargetSubtopic
        ' 
        cboTargetSubtopic.BackColor = Color.Transparent
        cboTargetSubtopic.BorderRadius = 8
        cboTargetSubtopic.CustomizableEdges = CustomizableEdges9
        cboTargetSubtopic.DrawMode = DrawMode.OwnerDrawFixed
        ...
        cboTargetSubtopic.Size = New Size(175, 36)
        cboTargetSubtopic.TabIndex = 5
        ' 
        ' cboTargetMetode
        ' 
        cboTargetMetode.BackColor = Color.Transparent
        cboTargetMetode.BorderRadius = 8
        cboTargetMetode.CustomizableEdges = CustomizableEdges11
        cboTargetMetode.DrawMode = DrawMode.OwnerDrawFixed
        ...
        cboTargetMetode.Size = New Size(175, 36)
        cboTargetMetode.TabIndex = 6
        ' 
        ' cboTargetRekomendasi
        ' 
        cboTargetRekomendasi.BackColor = Color.Transparent
        cboTargetRekomendasi.BorderRadius = 8
        cboTargetRekomendasi.CustomizableEdges = CustomizableEdges13
        cboTargetRekomendasi.DrawMode = DrawMode.OwnerDrawFixed
        ...
        cboTargetRekomendasi.Size = New Size(175, 36)
        cboTargetRekomendasi.TabIndex = 7
        ' 
        ' txtCFPakar
        ' 
        txtCFPakar.BorderRadius = 8
        txtCFPakar.CustomizableEdges = CustomizableEdges15
        txtCFPakar.DefaultText = ""
        txtCFPakar.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtCFPakar.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        ...
        txtCFPakar.Name = "txtCFPakar"
        txtCFPakar.PlaceholderText = ""
        ...
        Guna2HtmlLabel1.Location = New Point(96, 40)
        Guna2HtmlLabel1.Name = "Guna2HtmlLabel1"
        Guna2HtmlLabel1.Size = New Size(76, 22)
        Guna2HtmlLabel1.TabIndex = 12
        Guna2HtmlLabel1.Text = "Pertanyaan"
        ' 
        ' Guna2HtmlLabel2
        ' 
        Guna2HtmlLabel2.BackColor = Color.Transparent
        Guna2HtmlLabel2.Location = New Point(455, 40)
        Guna2HtmlLabel2.Name = "Guna2HtmlLabel2"
        Guna2HtmlLabel2.Size = New Size(59, 22)
        Guna2HtmlLabel2.TabIndex = 13
        Guna2HtmlLabel2.Text = "CF Pakar"
        ' 
        ' Guna2HtmlLabel3
        ' 
        ...
        Controls.Add(txtCFPakar)
        Controls.Add(cboTargetRekomendasi)
        Controls.Add(cboTargetMetode)
        Controls.Add(cboTargetSubtopic)
        Controls.Add(cboTargetTopic)
        Controls.Add(cboKategori)
        Controls.Add(cboLevel)
        Controls.Add(txtPertanyaan)
        Name = "FormAddEditQuestion"
        Text = "FormAddEditQuestion"
        ResumeLayout(False)
        PerformLayout()
    End Sub

    Friend WithEvents txtPertanyaan As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents cboLevel As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cboKategori As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cboTargetTopic As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cboTargetSubtopic As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cboTargetMetode As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents cboTargetRekomendasi As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents txtCFPakar As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents btnSave As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnCancel As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents lblTarget As Guna.UI2.WinForms.Guna2HtmlLabel
